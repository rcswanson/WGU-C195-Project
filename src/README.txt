...
User can fill in all information and hit add, adding the appointment/customer to the database. If an appointment/customer needs edited, user must select appointment/customer from table and hit edit appointment/customer.
Then the fields will populate with info. If any change in the customer tab, the refresh button must be pressed when moving back to teh appointemnts tab.
